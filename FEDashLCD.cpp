...
void FEDashLCD::updateDashboard() {
...
PGM_P FEDashLCD::blackRotaryString(int position) {
	return (PGM_P) pgm_read_word(&(RotaryBlackStringTable[position]));
}
PGM_P FEDashLCD::yellowRotaryString(int position) {
	return (PGM_P) pgm_read_word(&(RotaryYellowStringTable[position]));
}
PGM_P FEDashLCD::redRotaryString(int position) {
