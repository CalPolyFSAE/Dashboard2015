...
void FSAEDashLCD::updateDashboard() {
...
PGM_P FSAEDashLCD::yellowRotaryString(int position) {
	return (PGM_P) pgm_read_word(&(RotaryYellowStringTable[position]));
}
PGM_P FSAEDashLCD::redRotaryString(int position) {
	return (PGM_P) pgm_read_word(&(RotaryRedStringTable[position]));
}


bool FSAEDashLCD::warningOverride() {
